...
curl -s -X GET "%API%/precos-dll?niveis=2" -H "X-Api-Key: %KEY%"
echo.

echo === GET /precos-dll/04 (niveis=2) ===
curl -s -X GET "%API%/precos-dll/04?niveis=2" -H "X-Api-Key: %KEY%"
echo.

echo === GET /precos-dll/05 (niveis=2) ===
curl -s -X GET "%API%/precos-dll/05?niveis=2" -H "X-Api-Key: %KEY%"
echo.

echo === GET /precos-dll/04 (niveis=0) ===
curl -s -X GET "%API%/precos-dll/04?niveis=0" -H "X-Api-Key: %KEY%"
echo.
